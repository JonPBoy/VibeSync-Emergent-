...
export default function StylePreview({ style, onClose }) {
  ...
  // Calculate contrasting colors for the current style
  const bgColor = style.backgroundColor;
  const primaryTextColor = ensureContrast(style.primaryColor, bgColor);
  const secondaryTextColor = ensureContrast(style.secondaryColor, bgColor);
  const accentTextColor = ensureContrast(style.accentColor, bgColor);
  const bodyTextColor = ensureContrast(style.textColor, bgColor);
                  ...
                  <div className="flex gap-4 justify-center flex-wrap">
                    <button
                      ...
                      style={{
                        ...
                        color: getContrastingColor(style.accentColor),
